...
var ErrorMessage = function (_React$Component) {
  ...
  function ErrorMessage() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ErrorMessage.__proto__ || Object.getPrototypeOf(ErrorMessage)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      isExpanded: false
